...
| C-015 | EV-029, EV-030 | Hero photograph | **Unconfirmed** — not clearly UK Bangla Tigers | Real team photo, light-blue kit dominated by a charity/event-style heart/hands logo ("Leaf Care" text visible); small shoulder patches present but not legible as the UKBT crest | 2026-08-26 | OBSERVED (first-party); **team affiliation NOT confirmed** | MEDIUM | AVAILABLE_NEEDS_ADAPTATION (provisional) | `artifacts/brand/raw/images/hero/home-hero.webp` — Homepage-critical asset; see Homepage Contract for how this is handled without blocking |
