...
| U-03 | Founding date, founders, history, honours | about/history pages | **NARROWED, not closed** — `EV-20260826-029`: founding year 2020, read directly off the crest logo ("EST 2020"). Founders/honours/fuller history remain open |
| U-04 | Current roster, coaches, leadership, committee | players & leadership pages | **FURTHER NARROWED** — `EV-20260826-026`: Acting Chairman MD Shahidul Alam Ratan; Club Captain Mohammad Chowdhury. `EV-20260826-029` (a real management-team graphic): Mohammad Chowdhury also named Founder & CEO; Sayem Rahman named Vice-Chairman. `EV-20260831-005`: full 42-name UK Bangla Tigers roster and full 20-player Uppsala Tigers squad + 4 team officials (Coach, Team Manager, Logistics Manager, Team Mentor) now on record — names/countries only, closing the roster-*existence* gap "30+ Players" (an aggregate) left open. Individual full profiles (bio, stats, photo) beyond the Club Captain, coaching staff beyond the Uppsala coach, and full committee beyond Founder/CEO/Chairman/Vice-Chairman remain open |
